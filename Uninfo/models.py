...
class Curso(models.Model):
    ...
    descricaocurso = models.TextField(max_length=5000)
...
class Equipe(models.Model):
    ...
    competicoes = models.ManyToManyField(Competicao, related_name='equipes')
    coordenadores = models.ManyToManyField(Pessoa, related_name='equipes_coordenadas')
    subareas = models.ManyToManyField(Subrea, related_name='equipes', blank=True)
